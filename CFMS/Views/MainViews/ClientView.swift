    ...
    struct ClientView: View {
        ...
        @EnvironmentObject var authService: AuthService // 添加 AuthService 环境对象
        ...
        private func holdingRowView(for holding: FundHolding, hideClientInfo: Bool) -> some View {
                ...
                onCopyClientID: { message in
                    ...
                    if let currentUser = authService.currentUser {
                        if currentUser.userType == .free {
                            toastQueue.addToast("不支持基础用户使用此功能", type: .outdated)
                            return
                        }
                    }
            ...
            .environmentObject(authService) // 添加 AuthService 环境对象
        }
